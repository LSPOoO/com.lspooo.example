...
import com.lspooo.plugin.camera.state.CameraMachine;
...
public class JCameraView extends FrameLayout implements
    ...
    private void initView() {
        ...
        mSwitchCamera = (ImageView) view.findViewById(R.id.switch_view);
        mSwitchCamera.setImageResource(iconSrc);
        mFlashLamp = (ImageView) view.findViewById(R.id.flash_view);
        setFlashRes();
    ...
    public void cameraHasOpened() {
        CameraInterface.getInstance().doStartPreview(mVideoView.getHolder(), screenProp, this);
    }
...
//                    Log.i("CJT", "result = " + (result - firstTouchLength));
    ...
    public void startPreviewCallback() {
        ...
        setFocusViewWidthAnimation(mVideoView.getWidth() / 2, mVideoView.getHeight() / 2);
    }
