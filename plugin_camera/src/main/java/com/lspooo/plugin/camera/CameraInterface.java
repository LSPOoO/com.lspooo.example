...
import com.lspooo.plugin.camera.util.AngleUtil;
import com.lspooo.plugin.camera.util.CameraParamUtil;
import com.lspooo.plugin.camera.util.CheckPermission;
...
import com.lspooo.plugin.camera.util.ScreenUtils;
import com.lspooo.plugin.camera.view.CameraView;
...
public class CameraInterface implements Camera.PreviewCallback {
    ...
    public synchronized void switchCamera(SurfaceHolder holder, float screenProp, CameraView cameraView) {
        ...
        LogUtil.i("open end");
        doStartPreview(holder, screenProp, cameraView);
    }

    /**
     * doStartPreview
     */
    public void doStartPreview(SurfaceHolder holder, float screenProp, CameraView cameraView) {
        if (isPreviewing) {
        ...
        if (mCamera != null) {
            try {
                ...
                Camera.Size pictureSize = CameraParamUtil.getInstance().getPictureSize(mParams
                        .getSupportedPictureSizes(), 1600, screenProp);
                ...
                isPreviewing = true;
                if (cameraView != null) {
                    cameraView.startPreviewCallback();
                }
