...
import com.lspooo.plugin.common.tools.ScreenUtil;
...
public class TimeSelector {
    ...
    private int currentYear, currentMonth, currentDay, currentHour, currentMinitue;
    private int currentYearSelection, currentMonthSelection, currentDaySelection, currentHourSelection, currentMinitueSelection;
    ...
    private void initDialog() {
        if (seletorDialog == null) {
            ...
            seletorDialog.setContentView(R.layout.layout_time_selector);
    ...
    private void initParameter() {
        ...
        currentMinitue = currentCalendar.get(Calendar.MINUTE);
    ...
    private void initTimer() {
        ...
        if (spanYear) {
            for (int i = startYear; i <= endYear; i++) {
                ...
                if (currentYear == i){
                    currentYearSelection = i - startYear;
                }
            }
            for (int i = startMonth; i <= MAXMONTH; i++) {
                month.add(fomatTimeUnit(i));
                if (currentMonth == i){
                    currentMonthSelection = i - startMonth;
                }
            }
            for (int i = startDay; i <= startCalendar.getActualMaximum(Calendar.DAY_OF_MONTH); i++) {
                day.add(fomatTimeUnit(i));
                if (currentDay == i){
                    currentDaySelection = i - startDay;
                }
            }
            if ((scrollUnits & SCROLLTYPE.HOUR.value) != SCROLLTYPE.HOUR.value) {
                ...
                for (int i = startHour; i <= MAXHOUR; i++) {
                    ...
                    if (currentHour == i){
                        currentHourSelection = i - startHour;
                    }
                }
            }
            ...
            if ((scrollUnits & SCROLLTYPE.MINUTE.value) != SCROLLTYPE.MINUTE.value) {
                ...
                for (int i = startMininute; i <= MAXMINUTE; i++) {
                    ...
                    if (currentMinitue == i){
                        currentMinitueSelection = i - startMininute;
                    }
                }
            }
    ...
    private void loadComponent() {
        ...
        year_pv.setSelected(currentYearSelection);
        month_pv.setSelected(currentMonthSelection);
        day_pv.setSelected(currentDaySelection);
        hour_pv.setSelected(currentHourSelection);
        minute_pv.setSelected(currentMinitueSelection);
        excuteScroll();
    }
