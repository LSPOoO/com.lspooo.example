...
public class ECAlertDialog extends Dialog implements View.OnClickListener {
    ...
    public static ECAlertDialog buildAlert(Context ctx, int resId, OnClickListener listener) {
        return buildAlert(ctx, resId, R.string.app_dialog_cancel, R.string.app_dialog_confirm, null, listener);
    }
    ...
    public static ECAlertDialog buildAlert(Context ctx, int resId,
        ...
        return buildAlert(ctx, ctx.getString(resId), ctx.getString(R.string.app_dialog_cancel), ctx.getString(R.string.app_dialog_confirm), negativeClickListener, positive);
    }

    public static ECAlertDialog buildAlert(Context ctx, CharSequence message,
                                           OnClickListener listener) {
        return buildAlert(ctx, message, ctx.getString(R.string.app_dialog_cancel), ctx.getString(R.string.app_dialog_confirm), null, listener);
    }

    public static ECAlertDialog buildAlert(Context ctx, CharSequence message,
                                           OnClickListener negativeClickListener,
                                           OnClickListener positive) {
        return buildAlert(ctx, message, ctx.getString(R.string.app_dialog_cancel), ctx.getString(R.string.app_dialog_confirm), negativeClickListener, positive);
    }
    ...
    public static ECAlertDialog buildPositiveAlert(Context ctx , CharSequence message , OnClickListener listener) {
        ECAlertDialog dialog = new ECAlertDialog(ctx);
        dialog.setMessage(message);
        dialog.setButton(BUTTON_POSITIVE, ctx.getString(R.string.app_dialog_confirm), listener);
        return dialog;
    }
    ...
    public final void setTitleNormalColor() {
        ((TextView)findViewById(R.id.dialog_tv_title)).setTextColor(getContext().getResources().getColor(R.color.base_text_dark_color));
    }
