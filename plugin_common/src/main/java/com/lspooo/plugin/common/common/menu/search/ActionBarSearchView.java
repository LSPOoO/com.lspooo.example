...
public class ActionBarSearchView extends LinearLayout implements ISearch {
    ...
    private void initDelView() {
        if(mActionBarEditText.getEditableText() != null && !BackwardSupportUtil.isNullOrNil(mActionBarEditText.getEditableText().toString())) {
            setDelImageResource(R.drawable.ic_close_black, getResources().getDimensionPixelSize(R.dimen.LargestPadding));
        } else {
    ...
    private void init() {
        ((LayoutInflater) getContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE))
                .inflate(R.layout.layout_actionbar_search_view, this, true);
        mActionBackLayout = findViewById(R.id.actionbar_back_ll);
        mActionBackLayout.setOnClickListener(mOnBackListener);
        mActionBarEditText = (ActionBarEditText) findViewById(R.id.search_view);
