package com.lspooo.plugin.common.common.menu.search;
...
public class SearchViewHelper {
    ...
    public SearchViewHelper(boolean normal) {
        ...
        TAG = "RongXin.SearchViewHelper" + String.valueOf(System.currentTimeMillis());
    }
                ...
                public final void run() {
                    if (mMenuItem == null) {
                        ...
                        if (actionView != null && searchViewExpand) {
                            actionView.findViewById(R.id.search_view).requestFocus();
                            if (showSoftInput) {
                                mHandler.postDelayed(new Runnable() {
                                    @Override
                                    public void run() {
                                        ...
                                        if (service != null) {
                                            service.showSoftInput(actionView.findViewById(R.id.search_view), 0);
                                        }
                                    }
                                }, 128L);
                            }
    ...
    public void onCreateOptionsMenu(final FragmentActivity activity, Menu menu) {
        if (activity == null) {
            ...
            mMenuItem.setIcon(R.drawable.ic_search_black);
        ...
        mHandler.post(new Runnable() {
            ...
            public void run() {
                if (mMenuItem == null) {
                    ...
                    if (actionView != null) {
                        actionView.findViewById(R.id.search_view).clearFocus();
                    }
