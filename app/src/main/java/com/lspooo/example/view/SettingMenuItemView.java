...
import com.lspooo.plugin.common.view.SwitchButton;
...
public class SettingMenuItemView extends LinearLayout{
    ...
    public SettingMenuItemView(Context context, AttributeSet attrs, int defStyleAttr) {
